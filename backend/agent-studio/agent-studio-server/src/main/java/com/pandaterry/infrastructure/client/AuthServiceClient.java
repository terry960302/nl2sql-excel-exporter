...
public class AuthServiceClient extends BaseServiceClient {
    ...
    public Void signup(SignupRequest request) {
        return post(PREFIX + ApiPath.Auth.SIGNUP, request, null, Void.class);
    }

    // 로그인
    public TokenResponse signin(LoginRequest request) {
        return post(PREFIX + ApiPath.Auth.LOGIN, request, null, TokenResponse.class);
    }
    ...
    public UserInfoResponse me(UUID userId) {
        ...
        return get(PREFIX + ApiPath.Auth.ME, header, UserInfoResponse.class);
    }
    ...
    public TokenResponse refreshToken(String refreshToken) {
        ...
        return post(PREFIX + ApiPath.Auth.REFRESH_TOKEN, header, TokenResponse.class);
    }
    ...
    public Void logout(String refreshToken){
        Map<String, String> header = new HashMap<>();
        header.put(HeaderKeys.REFRESH_TOKEN, refreshToken);
        return post(PREFIX + ApiPath.Auth.LOGOUT, header, Void.class);
    }
}